    ...
    case(PASSED_LINE):
      ...
      if(popped_frontier == NULL) {
        ...
        if(front_wall_x == popped_frontier->x && front_wall_y == popped_frontier->y) {
          ...
          state_dir_t left_dir = (state_dir_t) ((dir + 3)%4);
          int left_x = updateXCoord(left_dir, x_coord);
          int left_y = updateYCoord(left_dir, y_coord);
          state_dir_t right_dir = (state_dir_t) ((dir + 1)%4);
          int right_x = updateXCoord(right_dir, x_coord);
          int right_y = updateYCoord(right_dir, y_coord);
